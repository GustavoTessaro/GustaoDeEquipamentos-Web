...
{
    private readonly InterfaceRepositorio<Equipamento> repositorioEquipamento;
    private readonly InterfaceRepositorio<Fabricante> repositorioFabricante;

    public EquipamentoController()
    {
        Serializable contexto = new Serializable();
        contexto.Carregar();
